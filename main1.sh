...
out_dir=/disk/genetics/ukb/mahdimir/imputed_genotype_corr_Tammys_analysis_replication/plink_out_sibs
...
/disk/genetics/tools/plink2/plink2 --bgen $bgen_fp ref-first --export bgen-1.2 --sample $sample_fp --keep $sibs_fp --extract $snps_99 --out "$out_dir"/bgen_99
